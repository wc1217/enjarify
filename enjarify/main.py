...
def translate(data, opts, classes=None, errors=None, allowErrors=True, skip=None):
    ...
    for cls in dex.classes:
        ...
        if unicode_name.startswith(tuple(skips)):
            # print('use skip class', unicode_name, skips)
            continue
...
def main():
    ...
    parser.add_argument('-p', '--skip', help='Exclude from decompiled package name list, | split, use startswith')
    ...
    for data in dexs:
        translate(data, opts=opts, classes=classes, errors=errors, skip=args.skip)
